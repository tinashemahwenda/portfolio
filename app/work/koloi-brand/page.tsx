...
export default function KoloiBrandManual() {
    return (
        <main className="min-h-screen bg-white selection:bg-black selection:text-white">
            ...
            <section className="pt-48 pb-24 px-6 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-8 max-w-4xl">
                    ...
                    >
                        A robust brand identity and bento-driven interface system crafted for a modern car and fleet tracking application.
                    </motion.p>
            ...
            >
                <div className="relative aspect-[16/9] w-full rounded-[2rem] overflow-hidden bg-gray-50 border border-black/5">
                    <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                        <span className="text-sm font-bold tracking-widest uppercase">Koloi Hero Graphic (16:9)</span>
                    </div>
                </div>
            </motion.section>
            ...
            <section className="px-6 max-w-7xl mx-auto mb-40">
                ...
                >
                    ...
                    <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="aspect-square bg-neutral-50 rounded-[2rem] border border-gray-100 flex items-center justify-center p-12 relative overflow-hidden">
                            <span className="text-xs font-bold text-gray-400 uppercase tracking-widest z-10">Primary Logo</span>
                        </div>
                        <div className="aspect-square bg-[#1A1A1A] rounded-[2rem] flex items-center justify-center p-12 relative overflow-hidden">
                            <span className="text-xs font-bold text-white/50 uppercase tracking-widest z-10">Inverted Logo</span>
                        </div>
                        <div className="md:col-span-2 aspect-[21/9] bg-neutral-50 rounded-[2rem] border border-gray-100 flex items-center justify-center p-12 relative overflow-hidden">
                            <span className="text-xs font-bold text-gray-400 uppercase tracking-widest z-10">Horizontal Lockup</span>
                        </div>
                    </div>
                </motion.div>
            </section>
                ...
                >
                    ...
                    <div className="md:col-span-8">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {[
                                { name: "Transit Blue", hex: "#0052FF", text: "text-white" },
                                { name: "Alert Orange", hex: "#FF4D00", text: "text-white" },
                                { name: "Dashboard Gray", hex: "#F3F4F6", text: "text-[#1A1A1A]" },
                                { name: "Asphalt Black", hex: "#111111", text: "text-white" }
                            ].map((color, i) => (
            ...
            <section className="px-6 max-w-7xl mx-auto mb-40">
                ...
                >
                    <h3 className="text-3xl font-extrabold tracking-tight text-[#1A1A1A] mb-8">
                        Bento Interface Explorations
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="aspect-[4/3] bg-neutral-100 rounded-[2rem] border border-black/5 overflow-hidden relative">
                            <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                                <span className="text-xs font-bold tracking-widest uppercase">Tracking Dashboard Mockup</span>
                            </div>
                        </div>
                        <div className="aspect-[4/3] bg-neutral-100 rounded-[2rem] border border-black/5 overflow-hidden relative">
                            <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                                <span className="text-xs font-bold tracking-widest uppercase">Fleet Analytics Bento</span>
                            </div>
                        </div>
                    </div>
                </motion.div>
